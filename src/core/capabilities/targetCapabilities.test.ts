...
describe('target capability registry', () => {
  it('keeps all compiler targets registered while exposing release-ready product targets', () => {
    ...
    expect(getTargetCapabilities('shadowrocket').baselineVersion).toBe('2.2.65 build 2615')
    ...
    expect(getTargetCapabilities('shadowrocket').productStatus).toBe('supported')
