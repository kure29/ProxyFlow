...
import claudeIcon from '../assets/services/claude.svg'
import githubIcon from '../assets/services/github.svg'
import googleIcon from '../assets/services/google.svg'
import netflixIcon from '../assets/services/netflix.svg'
import openAiIcon from '../assets/services/openai.svg'
import steamIcon from '../assets/services/steam.svg'
import telegramIcon from '../assets/services/telegram.svg'
...
// Service-only brand artwork is vendored from Simple Icons under CC0-1.0.
// OpenAI is a trademark of OpenAI; its mark is used only to identify the OpenAI service.
export const serviceCatalog: ServiceDefinition[] = [
  ...
  { id: 'gemini', name: 'Gemini', category: 'ai', description: 'Google Gemini', icon: googleIcon, ruleSources: [iosRuleSource('Gemini', 31)], defaultMatchers: ['DOMAIN-SUFFIX', 'IP-CIDR'] },
