...
export interface ShadowrocketCompileOptions { now?: () => Date; outputNodeId?: string; targetNativeStrategies?: TargetNativeStrategyIR[]; nativeStrategies?: TargetNativeStrategyIR[]; nativeRoutes?: import('../../core/targetNative').TargetNativeRouteIR[]; nativeFinalRoute?: import('../../core/targetNative').TargetNativeFinalRouteIR; targetNativeFinalOptions?: TargetNativeFinalOptionsIR; targetNativeRouteOptions?: import('../../core/targetNative').TargetNativeRouteOptionsIR[]; nativeRouteOptions?: import('../../core/targetNative').TargetNativeRouteOptionsIR[]; targetNativeRuleSetSources?: import('../../core/targetNative').TargetNativeRuleSetSourceIR[]; nativeRuleSetSources?: import('../../core/targetNative').TargetNativeRuleSetSourceIR[]; targetNativeSurgeGeneralNetwork?: TargetNativeSurgeGeneralNetworkIR; targetNativeSurgeGeneralConnectivity?: TargetNativeSurgeGeneralConnectivityIR; targetNativeSurgeGeneralProxyBypass?: TargetNativeSurgeGeneralProxyBypassIR; targetNativeSurgeDnsBehavior?: TargetNativeSurgeDnsBehaviorIR; effectiveDnsNodeId?: string }
