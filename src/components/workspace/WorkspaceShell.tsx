...
function dnsWorkspaceCopy(t: ReturnType<typeof useI18n>['t']): DnsWorkspaceCopy {
  return {
    ...
    generalTitle: t('workspace.dns.generalTitle'), generalDescription: t('workspace.dns.generalDescription'), clientSpecificTitle: t('workspace.dns.clientSpecificTitle'), clientSpecificDescription: t('workspace.dns.clientSpecificDescription'),
    mihomoTitle: t('workspace.dns.mihomoTitle'), mihomoDescription: t('workspace.dns.mihomoDescription'), surgeTitle: t('workspace.dns.surgeTitle'), surgeDescription: t('workspace.dns.surgeDescription'),
    directResolversTitle: t('workspace.dns.directResolversTitle'), fallbackResolversTitle: t('workspace.dns.fallbackResolversTitle'), addDirectResolver: t('workspace.dns.addDirectResolver'), addFallbackResolver: t('workspace.dns.addFallbackResolver'), generalEmpty: t('workspace.dns.generalEmpty'), directEmpty: t('workspace.dns.directEmpty'), fallbackEmpty: t('workspace.dns.fallbackEmpty'), retainedMihomo: t('workspace.dns.retained.mihomo'), retainedSurge: t('workspace.dns.retained.surge'),
