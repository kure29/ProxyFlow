  ...
  return (
    <header className="topbar">
      ...
      <div className="project-switcher-wrap">
        ...
        {projectMenuOpen && <div className="project-menu"><span>最近项目</span><button><Check size={13} /> {projectName}</button><button onClick={() => { createNewProject(); setProjectMenuOpen(false) }}>新建项目 <small>V0.5</small></button></div>}
      </div>
