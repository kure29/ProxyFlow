...
- Mihomo and sing-box are the only production targets in RC4. Surge is a future
...
- The incumbent quiet, utilitarian visual system remains the design authority
  for RC4. Client-first changes information architecture, not brand identity.

## Evidence on Hand

- Accepted product direction: `docs/product-direction.md`.
- Current implementation and validation status: `docs/current-status.md`.
- RC4 remains within the approved Client-first RC acceptance scope.
